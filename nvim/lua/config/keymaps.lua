...
-- Buffer management
vim.keymap.set("n", "<leader><cr>", ":update!<CR>", { desc = "Save, if changed" })
vim.keymap.set("n", "<leader>bw", ":write!<CR>", { desc = "Save" })
vim.keymap.set("n", "<leader>bW", ":noautocmd write!<CR>", { desc = "Save (no autocmd)" })
vim.keymap.set("n", "<leader>bu", ":update!<CR>", { desc = "Save, if changed" })
