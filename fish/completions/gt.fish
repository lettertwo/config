...
# commands that take branches (local)
complete -c gt -x -n "__fish_seen_subcommand_from checkout co bco delete dl rename rn onto --onto -o tr utr track untrack info get freeze unfreeze unlink" -a "(__fish_git_local_branches)"
