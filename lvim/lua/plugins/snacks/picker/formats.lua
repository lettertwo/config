...
return {
  ...
  opts = {
    picker = {
      -- stylua: ignore
      sources = {
        files        = { format = title_path },
        recent       = { format = title_path },
        grep         = { format = title_path },
        directories  = { format = title_path },
        node_modules = { format = title_path },
        plugins      = { format = title_path },
        switch       = { format = title_path },
      },
    },
  },
}
